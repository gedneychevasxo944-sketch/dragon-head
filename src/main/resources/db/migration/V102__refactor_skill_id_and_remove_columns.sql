...
DROP TABLE IF EXISTS skill_bindings;
...
-- 重建 skill_versions 表（skill_id 引用改为 skills.id VARCHAR(64)）
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='技能调用日志表';
