...
VALUES
  ...
  -- id=2 已被 V2 的 system 用户占用，admin 改到 id=3
  (3, 'admin', '13800138001', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', '管理员', 'https://api.dicebear.com/7.x/avataaars/svg?seed=admin', 'NORMAL', 0, NOW(), NOW()),
  (4, 'operator', '13800138002', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', '操作员', 'https://api.dicebear.com/7.x/avataaars/svg?seed=operator', 'NORMAL', 0, NOW(), NOW()),
  (5, 'viewer', '13800138003', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', '查看者', 'https://api.dicebear.com/7.x/avataaars/svg?seed=viewer', 'NORMAL', 0, NOW(), NOW()),
  (6, 'alice', '13800138004', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'Alice', 'https://api.dicebear.com/7.x/avataaars/svg?seed=alice', 'NORMAL', 0, NOW(), NOW()),
  (7, 'bob', '13800138005', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'Bob', 'https://api.dicebear.com/7.x/avataaars/svg?seed=bob', 'NORMAL', 0, NOW(), NOW());
-- system 用户已在 V2 中插入 (id=2)
...
VALUES
  -- Workspace 资产（id=2 已被 system 占用，admin 改到 id=3）
  ('WORKSPACE', 'ws-demo', 1, 'OWNER', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('WORKSPACE', 'ws-demo', 3, 'ADMIN', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('WORKSPACE', 'ws-demo', 4, 'COLLABORATOR', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('WORKSPACE', 'ws-demo', 5, 'MEMBER', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('WORKSPACE', 'ws-demo', 6, 'COLLABORATOR', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('WORKSPACE', 'ws-demo', 7, 'MEMBER', '3', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('WORKSPACE', 'ws-test', 1, 'OWNER', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('WORKSPACE', 'ws-test', 3, 'ADMIN', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('WORKSPACE', 'ws-test', 4, 'COLLABORATOR', '1', NOW(), NOW(), TRUE, NOW(), NOW()),

  -- Character 资产
  ('CHARACTER', 'char-001', 1, 'OWNER', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('CHARACTER', 'char-001', 3, 'ADMIN', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('CHARACTER', 'char-001', 4, 'COLLABORATOR', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ...
  ('CHARACTER', 'char-pm', 3, 'ADMIN', '1', NOW(), NOW(), TRUE, NOW(), NOW()),

  -- Skill 资产
  ('SKILL', 'skill-001', 1, 'OWNER', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('SKILL', 'skill-001', 3, 'ADMIN', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
  ('SKILL', 'skill-001', 4, 'COLLABORATOR', '1', NOW(), NOW(), TRUE, NOW(), NOW()),
