...
-- Registry 配置
INSERT INTO config_store (id, scope_bit, workspace_id, character_id, tool_id, skill_id, memory_id, config_key, config_value, value_type, status, version, created_at, updated_at)
VALUES ('5::::::registry.defaultCharacterId', 5, NULL, NULL, NULL, NULL, NULL, 'registry.defaultCharacterId', '', 'STRING', 'PUBLISHED', 1, NOW(), NOW())
ON DUPLICATE KEY UPDATE config_value = VALUES(config_value), updated_at = NOW();

INSERT INTO config_store (id, scope_bit, workspace_id, character_id, tool_id, skill_id, memory_id, config_key, config_value, value_type, status, version, created_at, updated_at)
VALUES ('5::::::registry.defaultModelId', 5, NULL, NULL, NULL, NULL, NULL, 'registry.defaultModelId', '', 'STRING', 'PUBLISHED', 1, NOW(), NOW())
ON DUPLICATE KEY UPDATE config_value = VALUES(config_value), updated_at = NOW();

INSERT INTO config_store (id, scope_bit, workspace_id, character_id, tool_id, skill_id, memory_id, config_key, config_value, value_type, status, version, created_at, updated_at)
VALUES ('5::::::registry.defaultObserverId', 5, NULL, NULL, NULL, NULL, NULL, 'registry.defaultObserverId', '', 'STRING', 'PUBLISHED', 1, NOW(), NOW())
ON DUPLICATE KEY UPDATE config_value = VALUES(config_value), updated_at = NOW();
