...
--   - V1 Skill 表（skill, skill_binding, skill_usage_log）
...
--   （注意：V102 已将 skills/skill_versions/skill_bindings/skill_usage_logs 统一改为单数表名）
...
-- Skill 表（版本设计：每次更新 INSERT 新记录，skillId 不变，version +1）
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Skill 使用记录表';
