...
public final class HooksRoutes {
    ...
    public static Object handleHooksDialog(RouteContext ctx, FullHttpRequest request,
        ...
        if (accept) {
            org.dragon.tool.runtime.tools.browser.playwright.PwToolsCore.acceptDialog(page, promptText);
        } else {
            org.dragon.tool.runtime.tools.browser.playwright.PwToolsCore.dismissDialog(page);
        }
    ...
    public static Object handleHooksFileChooser(RouteContext ctx, FullHttpRequest request,
        ...
        org.dragon.tool.runtime.tools.browser.playwright.PwToolsCore.setInputFiles(page, selector, filePaths);
        return Map.of("ok", true);
    }
    ...
    public static Object handleTraceStart(RouteContext ctx, FullHttpRequest request,
        ...
        var page = session.resolveTargetPage(targetId);
        org.dragon.tool.runtime.tools.browser.playwright.PwToolsCore
    ...
    public static Object handleTraceStop(RouteContext ctx, FullHttpRequest request,
        ...
        org.dragon.tool.runtime.tools.browser.playwright.PwToolsCore.stopTracing(page.context(), outputPath);
    ...
    public static Object handleHighlight(RouteContext ctx, FullHttpRequest request,
        ...
        org.dragon.tool.runtime.tools.browser.playwright.PwToolsCore.highlight(page, selector);
        return Map.of("ok", true);
    }
    ...
    public static Object handlePdf(RouteContext ctx, FullHttpRequest request,
        ...
        String targetId = reqBody != null ? (String) reqBody.get("targetId") : null;
        var page = session.resolveTargetPage(targetId);
        byte[] pdf = org.dragon.tool.runtime.tools.browser.playwright.PwToolsCore.generatePdf(page);
        try {
