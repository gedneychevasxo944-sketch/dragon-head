...
public class WorkspaceHiringService {
    ...
    private CharacterDutyStore getCharacterDutyStore() {
        return storeFactory.get(CharacterDutyStore.class);
    }
    ...
    public void setCharacterDuty(String workspaceId, String characterId, String dutyDescription) {
        ...
        Optional<CharacterDuty> existing = getCharacterDutyStore().findById(dutyId);
        ...
        if (existing.isPresent()) {
            ...
            getCharacterDutyStore().update(duty);
        } else {
            duty = CharacterDuty.builder()
                    ...
                    .updatedAt(now)
                    .build();
            getCharacterDutyStore().save(duty);
        }
    ...
    public Optional<CharacterDuty> getCharacterDuty(String workspaceId, String characterId) {
        return getCharacterDutyStore().findByWorkspaceIdAndCharacterId(workspaceId, characterId);
    }
