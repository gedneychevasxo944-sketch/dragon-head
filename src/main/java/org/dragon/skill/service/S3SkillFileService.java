...
public class S3SkillFileService implements SkillFileService {

    private final StorageType type = StorageType.S3;
    /** S3 bucket 名称 */
    ...
    @Autowired
    public S3SkillFileService(ConfigApplication configApplication) {
    ...
    public StorageInfo upload(String skillId, int version, Map<String, byte[]> fileMap) {
        ...
        storageInfo.setBucket(s3Bucket);
