...
public class ResumeStep implements Step {
    ...
    public StepResult execute(ExecutionContext ctx) {
        ...
        // 设置结果到上下文
        TaskContextConfig.setContinuationConfig(ctx, result.decision.name(), result.targetTaskId, result.targetTaskType);
    ...
    private NormalizedMessage getMessageFromContext(ExecutionContext ctx) {
